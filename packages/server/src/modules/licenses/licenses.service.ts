...
export class LicensesService {
  ...
  async generate(dto: GenerateLicenseDto, adminId: string) {
    ...
    while (plaintexts.length < dto.count) {
      ...
      rows.push({
        ...
        quotaPerDevice: dto.quota_per_device ?? plan.quotaPerDevice ?? null,
        batchId,
        note: dto.note ?? null,
        createdBy: adminId,
        createdAt: now,
  ...
  private toBrief(l: any) {
    return {
      ...
      quota_per_device: l.quotaPerDevice,
      is_count_card: l.quotaPerDevice !== null,
      batch_id: l.batchId,
      note: l.note,
  ...
  private deviceDto(d: any) {
    return {
      ...
      quota_total: d.quotaTotal,
      quota_used: d.quotaUsed,
      quota_reserved: d.quotaReserved,
      quota_available: d.quotaTotal != null ? d.quotaTotal - d.quotaUsed - d.quotaReserved : null,
